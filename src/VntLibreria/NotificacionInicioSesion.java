 ...
 * @author HP
 */
public class NotificacionInicioSesion extends javax.swing.JFrame
{

    /**
     * Creates new form Notificacion1
     */
    public NotificacionInicioSesion()
    {
        initComponents();
   ...
   Image icono = Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenesG/buhoAzul.png"));
        ...
        AudioClip music;
        music = Applet.newAudioClip(ClassLoader.getSystemResource("Windows 8 Sounds/Windows Logon.wav"));
        music.play();
    ...
    private void initComponents()
    {
        ...
        jLabel9.setText("Has iniciado sesión  ");
