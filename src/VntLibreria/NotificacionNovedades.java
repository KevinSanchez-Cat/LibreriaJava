 ...
 * @author HP
 */
public class NotificacionNovedades extends javax.swing.JFrame
{

    /**
     * Creates new form Notificacion1
     */
    public NotificacionNovedades()
    {
        initComponents();
   ...
   Image icono = Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("imagenesG/buhoAzul.png"));
       ...
       setResizable(false);
        ...
        AudioClip music;
        music = Applet.newAudioClip(ClassLoader.getSystemResource("Windows 8 Sounds/Novedades.wav"));
        music.play();
    ...
    private void initComponents()
    {
        ...
        jLabel9.setText("Echa un vistazo a las novedades..");
